...
router.post('/:wordID', Auth.isConnected, Auth.isAdmin, WordController.updateWord);
...
router.delete('/:wordID', Auth.isConnected, Auth.isAdmin, WordController.deleteWord);
